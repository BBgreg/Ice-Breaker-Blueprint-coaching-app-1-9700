...
const Dashboard = () => {
  ...
  const { setBlueprint, userStats } = useUser();
      ...
      iceBreakers: [
        {
          ...
          text: "I saw your recent post on the future of supply chains. How do you see generative AI impacting logistics over the next 5 years?",
          explanation: "Positions you as an informed peer and opens a high-level professional dialogue."
        },
        {
          type: "Comment + Question",
          text: "That's an amazing shot from Machu Picchu! Was the hike as tough as they say?",
          explanation: "Shows genuine interest in their personal experiences and creates an opportunity for storytelling."
        },
        {
          type: "Comment + Question",
          text: "Congratulations on your son's graduation from UCLA! As a fellow professional balancing work and family, how do you manage to stay so engaged in your career while celebrating these big family moments?",
          explanation: "Acknowledges personal milestone and shows you see them as a whole person, not just a job title."
        },
        {
          type: "Comment + Question",
          text: "Your career progression in product management is really inspiring. What do you consider the most critical skill for a product manager to develop today?",
          explanation: "Combines genuine compliment with request for mentorship-style advice, effective for professional relationships."
        }
      ],
      discoveryQuestions: [
        {
          text: "I'm exploring new project management tools. Have you come across any that integrate well with a remote-first engineering team?",
          explanation: "Creates natural opening for them to discuss their work without directly mentioning their employer."
        },
        {
          text: "I'm looking to get outdoors more this weekend, have you found any good trails around here?",
          explanation: "Subtle way to discover their hiking interests without revealing you've researched them."
        },
        {
          text: "I saw your post celebrating your son's graduation - congrats! My niece is starting to look at colleges in California. Did he have a favorite thing about his time at UCLA?",
          explanation: "Creates personal connection by asking for advice, which is subtle and effective for building rapport."
        },
        {
          text: "Your job sounds incredibly rewarding but also probably pretty exhausting. When you're not shaping young minds, what's your favorite way to recharge?",
          explanation: "Shows empathy and pivots conversation toward their personal life and hobbies."
        }
      ],
      valueAdds: [
        {
          ...
          explanation: "Provides relevant industry insight directly related to their professional focus."
        },
        {
          ...
          explanation: "Offers valuable professional connection that could benefit their career."
        },
        {
          ...
          explanation: "Shows you've paid attention to their interests and offers shared experience opportunity."
        }
      ],
      followUp: {
